...
control '2.2.2_L1_Ensure_Access_this_computer_from_the_network_is_set_to_Administrators_Remote_Desktop_Users' do
  ...
  impact 1.0
  tag cce: 'CCE-32928-4'
  allowed_principals = ['BUILTIN\\Administrators', 'BUILTIN\\Remote Desktop Users']
  describe security_policy.SeNetworkLogonRight | allowed_principals do
    it { should match_array allowed_principals }
  end
end
...
control '2.2.4_L1_Ensure_Adjust_memory_quotas_for_a_process_is_set_to_Administrators_LOCAL_SERVICE_NETWORK_SERVICE' do
  ...
  impact 1.0
  tag cce: 'CCE-35490-2'
  allowed_principals = ['BUILTIN\\Administrators', 'NT AUTHORITY\\LOCAL SERVICE', 'NT AUTHORITY\\NETWORK SERVICE']
...
control '2.2.5_L1_Ensure_Allow_log_on_locally_is_set_to_Administrators_Users' do
  ...
  impact 1.0
  tag cce: 'CCE-35640-2'
  allowed_principals = ['BUILTIN\\Administrators', 'NT AUTHORITY\\Authenticated Users']
